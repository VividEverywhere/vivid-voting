<?php
    ...
    class Updater
    {
        ...
        {
            if (defined('VIVID_VOTING_DEV_MODE')) {
        ...
        public function request()
        {
            ...
            if (false === $remote || !$this->cache_allowed) {
                $remote = wp_remote_get('https://plugins.vivideverywhere.co.uk/voting/plugin.json', [
                        'timeout' => 10,
                        'headers' => [
                ...
                if (is_wp_error($remote) || 200 !== wp_remote_retrieve_response_code(
                        $remote
        ...
        public function update($transient)
        {
            ...
            if ($remote && version_compare($this->version, $remote->version, '<') && version_compare(
                    $remote->requires,
